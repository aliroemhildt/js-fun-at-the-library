...
if (pages < 1000) {
  ...
  console.log("Ok, maybe I could read tha tin a day and a half");
}
...
var books = ["To Kill a Mockingbird", "The Great Gatsby", "Catcher in the Rye", "Lord of the Flies", "1984"];
...
belowTwoHundred = [15, 155, 38, 174, 55, 134, 99, 80, 6, 24, 3, 76];
